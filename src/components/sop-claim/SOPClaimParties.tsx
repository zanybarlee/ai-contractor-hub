...
interface SOPClaimPartiesProps {
  data: any;
  onChange: (field: string, value: string) => void;
}

const SOPClaimParties: React.FC<SOPClaimPartiesProps> = ({ data, onChange }) => {
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Details of the party receiving the payment claim
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Details of the party making the payment claim
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
...
export default SOPClaimParties;
