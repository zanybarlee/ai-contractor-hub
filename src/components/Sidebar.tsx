...
import { Home, FileText, AlertTriangle, Users, Settings, GitBranch, Brain, Scale, LogOut, ClipboardCheck, Briefcase, Search, HardHat } from "lucide-react";
...
const navigation = [
  ...
  { name: "Contractors", icon: HardHat, href: "/contractors" },
